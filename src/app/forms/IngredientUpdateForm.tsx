        ...
        <DialogContent>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Input type="number" id="caloriesPer100g" {...register("caloriesPer100g")} />
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Input type="number" id="proteinPer100g" {...register("proteinPer100g")} />
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Input type="number" id="carbsPer100g" {...register("carbsPer100g")} />
